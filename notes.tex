...
\begin{itemize}
    ...
    \item \textbf{Lecture 16 Theorem (Necessary conditions for optimal binary prefix codes): } Let \(\mathcal{C}\) be an \textit{optimal} binary prefix code with %write this out later
